var answerList = ['finland', 'sweden', 'jamaica', 'laos', 'syria', 'vietnam', 'india',
 'saudi arabia', 'ghana', 'greece'];
var score = 0;
var answer = '';
var temp = ''
...
function validate () {
	...
	if (score > 9) {scoreText.innerHTML = 'Perfect! Your score is ' + score * 10 + '! You are a flag grandmaster.'

var answerList = ['indonesia', 'japan', 'netherlands', 'thailand', 'china', 'malaysia', 'spain',
 'german', 'singapore', 'france'];
var score = 0;
var answer = '';
var temp = ''
...
function validate () {
	...
	if (score > 9) {scoreText.innerHTML = 'Perfect! Your score is ' + score * 10 + '! You are a flag master.'
